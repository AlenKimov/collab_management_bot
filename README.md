...
После добавления администратора желатьно зайти с аккаунта администратора в бота и прописать команду [`/set_username`](##Команды%20бота)

Администратор может удалить администратора через бота командой [`/delete_manager`](##Команды%20бота)
...
- База данных
	...
	- [x] Миграции Alembic
		...
		- [ ] (разово, необязательно) Избавиться от триггеров: перенести логику триггеров в Python
